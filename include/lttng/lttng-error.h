...
enum lttng_error_code {
	...
	LTTNG_ERR_SESSION_NOT_STARTED    = 117, /* Session not started */
	LTTNG_ERR_LIVE_SESSION           = 118, /* Live session unsupported */
	LTTNG_ERR_PER_PID_SESSION        = 119, /* Per-PID sessions unsupported */
